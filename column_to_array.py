...
#-------------------------------------------------------------------------------
# Name:         Datamining Tools: Column to Array
#
# Purpose:      This is a web based datamining tool that makes it easier to get columns of spreadsheet data into
...
#
# Author:       Chris Nielsen (christopher.nielsen@here.com)
# Created:      Feb. 12, 2015
#-------------------------------------------------------------------------------
...
<title>Data Mining Tools: Column to Array</title>
...
<h1>Data Mining Tools: Column to Array</h1>
<pre>This is a web based data mining tool that makes it easier to get columns of spreadsheet data into
your Python script as an array. Instead of having to parse spreadsheets from within your script,
all you have to do is copy and paste a column of data into the web form and this script will produce a
Pythonic list (array) that can be copied into your script. Created with Python 2.7.5</pre>
    ...
    <BR>
    <form name="list_form" action="http://bluegalaxy.info/cgi-bin/column_to_array.py" method='POST'>

    <table>
        <tr>
            <td>&nbsp;<b>Paste column of data here:</b><BR>
                <TEXTAREA NAME="input" COLS=28 ROWS=18"></TEXTAREA></td>
        </tr>
        <tr>
            <td>
